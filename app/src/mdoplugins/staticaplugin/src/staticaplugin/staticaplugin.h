...
#ifndef STATICAPUGIN_H
#define STATICAPUGIN_H
...
class StaticaPlugin : public QObject, public IPlugin
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "com.code0x378.StaticaPlugin")
